...
#### Audio Models (Special handling, automatically processed internally by TokenJump)
...
TokenJump adopts a dual billing mechanism of pre-consumption and post-consumption:
