...
This document provides detailed configuration steps and best practices for TokenJump cluster deployment, helping you build a highly available, load-balanced distributed system.
...
The TokenJump cluster adopts a master-slave architecture design:
