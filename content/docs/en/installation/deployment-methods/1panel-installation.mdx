...
This document provides a graphical tutorial for deploying TokenJump using the 1Panel panel.
...
## Step 2: Install TokenJump

### Search for Applications

<Callout type="info" title="Search for Applications">
  Go to the application list in the App Store, find the TokenJump application under the [AI] category, and install it.
</Callout>
...
<Callout type="info" title="Install Application">
  Configure TokenJump application parameters on the installation page:
</Callout>

- **Name**: The name of the TokenJump application to be created
- **Version**: Select the version of TokenJump
- **Port**: The service port for the TokenJump application
...
<Callout type="info" title="Confirm Installation">
  Click Confirm to start the installation. The page will automatically redirect to the installed applications list. Wait for the TokenJump application status to change to Started.
</Callout>
...
1. In the 1Panel application list, click the **Parameters** button for the TokenJump application
...
## Step 4: Access TokenJump

<Callout type="info" title="Access Application">
  - On the `Installed` page, click `Jump` to enter the TokenJump WebUI page
...
2. Find the TokenJump application, click the **Upgrade** button
...
- [GitHub Repository](https://github.com/AItoken-cloud/tokenjump-docs-v1)