...
This document provides methods and best practices for updating the TokenJump system to ensure a smooth upgrade to the latest version.
...
If you have deployed TokenJump using a single Docker container, you can update by following these steps:
...
2.  Find the TokenJump application and click the **Upgrade** button
...
2.  Find the TokenJump container, click **More** -> **Recreate**
...
If you have deployed TokenJump by compiling from source code, the update steps are as follows:
