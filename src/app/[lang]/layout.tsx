...
> = {
  en: {
    default: 'TokenJump - The Foundation of Your AI Universe',
    template: '%s | TokenJump',
    description:
  ...
  zh: {
    default: 'TokenJump - AI 基座',
    template: '%s | TokenJump',
    description:
      '承载所有 AI 应用，管理你的数字资产，连接未来的统一基础设施平台。快速部署，轻松扩展。',
  },
  ja: {
    default: 'TokenJump - あなたの AI ユニバースの基盤',
    template: '%s | TokenJump',
    description:
...
export async function generateMetadata({
  ...
  return createMetadata({
    ...
    authors: [
      { name: 'TokenJump Team', url: 'https://github.com/AItoken-cloud/tokenjump-docs-v1' },
    ],
    creator: 'TokenJump Team',
    alternates: {
      languages: {
        en: '/en',
        zh: '/zh',
